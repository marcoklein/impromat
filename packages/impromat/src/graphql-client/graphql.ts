...
export type WorkshopInfoList_WorkshopFragment = { __typename?: 'Workshop', id: string, createdAt: any, updatedAt: any } & { ' $fragmentName'?: 'WorkshopInfoList_WorkshopFragment' };

...
export type LibraryCreateCustomElement_QueryQuery = { __typename?: 'Query', element?: { __typename?: 'Element', id: string, name: string, visibility: ElementVisibility, markdown?: string | null, languageCode?: string | null } | null };

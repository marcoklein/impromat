...
export type WorkshopPage_WorkshopFragment = (
  ...
  & { ' $fragmentRefs'?: { 'WorkshopElementsComponent_WorkshopFragment': WorkshopElementsComponent_WorkshopFragment;'WorkshopActionSheet_WorkshopFragment': WorkshopActionSheet_WorkshopFragment } }
...
export type WorkshopPreviewItem_WorkshopFragment = (
  { __typename?: 'Workshop', id: string, version: number, createdAt: any, updatedAt: any, deleted: boolean, name: string, description?: string | null }
  & { ' $fragmentRefs'?: { 'WorkshopInfoList_WorkshopFragment': WorkshopInfoList_WorkshopFragment } }

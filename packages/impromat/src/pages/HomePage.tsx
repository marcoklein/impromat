...
export const HomePage: React.FC = () => {
  ...
  return (
    <IonPage>
      <IonContent className="ion-padding" scrollEvents onIonScroll={onScroll}>
        ...
        <div style={{ height: "85%", display: "flex", alignItems: "center" }}>
          <div className="ion-text-center">
            <div
              ...
              style={{ maxHeight: "20%", maxWidth: "20%", margin: "0 auto" }}
            >
            ...
            <IonText color="medium">
              <h1>
                The app for planning, holding, and sharing improvisational
                theatre workshops.
              </h1>
            </IonText>
            <IonButton
        ...
        <IonText>
          <h2>Made For All Improvisers</h2>
        </IonText>
        <IonText color="medium">
        ...
        <IonText color="medium">
          <p>
            ...
            Impromat helps you to find exercises and games for your first improv
            session.
          </p>
        </IonText>
        <IonText color="dark">
        ...
        <IonText color="medium">
          <p>
            Are you playing in an improv group already and you are looking for
            new inspiration for your next workshops? Impromat helps you with
        ...
        <IonText color="medium">
          Are you regularly holding improv workshops within your own group or
          for others? With Impromat you can easily plan, hold, and share your
          workshops.
        </IonText>
        <IonButton
          fill="outline"
        ...
        <IonText color="medium">
          Developed by improvisers, made for improvisers. Impromat offers all
          necessary features to plan upcoming improv sessions.
        </IonText>
        <IonText color="dark">
        ...
        <IonText color="medium">
          <p>
            Plan and manage your own improvisational theatre workshops, share
            them with the community, or find inspiring workshops from other
            improvisers.
          </p>
        </IonText>
        ...
        <IonText color="medium">
          <p>
            Explore over one thousand existing improv exercises and games from
            various sources like{" "}
            <a href="https://improwiki.com" target="_blank" rel="noreferrer">
              Improwiki
            </a>
            ,{" "}
            <a
        ...
        <IonText color="medium">
          <p>
            Impromat lives from your workshop and elements contributions. If you
            do something cool with it, have feedback, or new ideas drop an email
            at{" "}
            <a href="mailto:impromat@marcoklein.dev">impromat@marcoklein.dev</a>{" "}

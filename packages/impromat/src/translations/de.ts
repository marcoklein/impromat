...
export default {
  ...
  HomeContent: {
    ...
    ImprovBibDescription:
      "Entdecke über 1000 bestehende Improvisationsübungen und -spiele in der <b>Bibliothek der Elemente</b>. Die Elemente wurden aus verschiedenen <b>Wiki-Quellen</b> in Deutsch und Englisch extrahiert: <ImprowikiLink>Improwiki</ImprowikiLink>, <LearnimprovLink>Learnimprov</LearnimprovLink> and <ImprovRCLink>Improv Resource Center</ImprovRCLink>. Nutze die <b>Filterkategorien</b> in der Suche und die <b>Empfehlungsfunktion</b>, um ähnliche Elemente zu finden, die du in deinen Workshop einbauen kannst.",
    "Improv Workshops": "Impro-Workshops",
    GoToElements: "Öffne Übungen & Spiele",

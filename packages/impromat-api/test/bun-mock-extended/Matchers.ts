...
export const anyBoolean: MatcherCreator<boolean> = () =>
  new Matcher(
    (actualValue: boolean) => typeof actualValue === 'boolean',
    'anyBoolean()',
  );
...
export const anyString: MatcherCreator<string> = () =>
  new Matcher(
    (actualValue: string) => typeof actualValue === 'string',
    'anyString()',
  );
export const anyFunction: MatcherCreator<Function> = () =>
  new Matcher(
    (actualValue: Function) => typeof actualValue === 'function',
    'anyFunction()',
  );
export const anySymbol: MatcherCreator<Symbol> = () =>
...
export const anyArray: MatcherCreator<any[]> = () =>
  new Matcher((actualValue) => Array.isArray(actualValue), 'anyArray()');
export const anyMap: MatcherCreator<Map<any, any>> = () =>
  new Matcher((actualValue) => actualValue instanceof Map, 'anyMap()');
export const anySet: MatcherCreator<Set<any>> = () =>
  new Matcher((actualValue) => actualValue instanceof Set, 'anySet()');
export const isA: MatcherCreator<any> = (clazz) =>
  new Matcher((actualValue) => actualValue instanceof clazz, 'isA()');

export const arrayIncludes: MatcherCreator<any[], any> = (arrayVal) =>
  new Matcher(
    (actualValue) =>
      Array.isArray(actualValue) && actualValue.includes(arrayVal),
    'arrayIncludes()',
  );
export const setHas: MatcherCreator<Set<any>, any> = (arrayVal) =>
  new Matcher(
    (actualValue) =>
      anySet().asymmetricMatch(actualValue) && actualValue!.has(arrayVal),
    'setHas()',
  );
export const mapHas: MatcherCreator<Map<any, any>, any> = (mapVal) =>
  new Matcher(
    (actualValue) =>
      anyMap().asymmetricMatch(actualValue) && actualValue!.has(mapVal),
    'mapHas()',
  );
export const objectContainsKey: MatcherCreator<any, string> = (key) =>
  new Matcher(
    (actualValue) =>
      anyObject().asymmetricMatch(actualValue) &&
...
export const notNull: MatcherCreator<any> = () =>
  new Matcher((actualValue) => actualValue !== null, 'notNull()');
export const notUndefined: MatcherCreator<any> = () =>
...
export const matches = <T extends any = any>(matcher: MatcherFn<T>) =>
  new Matcher(matcher, 'matches()');
